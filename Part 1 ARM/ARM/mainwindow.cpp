    ...
    , ui(new Ui::MainWindow)
{
    ...
    db.setDatabaseName("C:/Qt/Creative task/Part 1 ARM/ARM/mydatabase.db");
    if (!db.open()) {
...
void MainWindow::on_pushButton_clicked()
{
    ...
    for (int row = 0; row < model->rowCount(); ++row) {
        QModelIndex index = model->index(row, 2); // индекс ячейки в третьем столбце
        if (index.data().toString().trimmed().isEmpty())// проверяем, есть ли значение в ячейке
            model->setData(index, 0, Qt::EditRole); // зануляем значение, если оно отсутствует
        model->submitAll();
    }
...
void MainWindow::on_pushButton_3_clicked()
{
    ...
    QFont font("MS Shell Dlq 2", 16); // создаем объект QFont с указанным размером шрифта
    orderManually->setFont(font); // устанавливаем шрифт для кнопки
    orderManually->setStyleSheet("background-color: #cdffdf; color: black;");
    orderManually->setGeometry(40,40,350,90);
    orderManually->show();
    ...
    orderAutomatically->setStyleSheet("background-color: #cdffdf; color: black;");
    orderAutomatically->setGeometry(40,170,350,90);
    ...
    button->setStyleSheet("background-color: black; color: white;");
    button->setGeometry(40, 300, 350, 50);
    button->show();
...
void MainWindow::on_pushButton_4_clicked()
{
    ...
    nameLabel->setGeometry(0,5,535,25);
    nameLabel->show();

// ----------------------------------------------------------------------
    dayButton = new QPushButton("День", this);
    dayButton->setGeometry(0,35,107,30);
    dayButton->setStyleSheet("background-color: #cdffdf; color: black;");
    dayButton->show();
...
// ----------------------------------------------------------------------
    ...
    weekButton->setStyleSheet("background-color: #cdffdf; color: black;");
    weekButton->show();
...
// ----------------------------------------------------------------------
    ...
    monthButton->setStyleSheet("background-color: #cdffdf; color: black;");
    monthButton->show();
...
// ----------------------------------------------------------------------
    ...
    halfYearButton->setStyleSheet("background-color: #cdffdf; color: black;");
    halfYearButton->show();
...
// ----------------------------------------------------------------------
    ...
    YearButton->setStyleSheet("background-color: #cdffdf; color: black;");
    YearButton->show();
